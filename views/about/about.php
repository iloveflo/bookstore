                    ...
                    <div class="card-body py-0">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-8 col-xl-6 col-xxl-5 p-4 p-lg-5">
                                ...
                                <div class="d-grid bottom-0"><a class="btn btn-lg btn-primary w-50 mt-xl-6" href="#!">XEM CHI TIẾT<i class="fas fa-chevron-right ms-2"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body py-0">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-7 col-xl-6 col-xxl-5 p-4 p-lg-5">
                                ...
                                <div class="d-grid bottom-0"><a class="btn btn-lg w-50 btn-primary mt-xl-6" href="#!">XEM CHI TIẾT<i class="fas fa-chevron-right ms-2"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
